...
@section('content')
    ...
    <section id="explore_area" class="section_padding">
        <div class="container">
            <div class="row">
                <div class="col-lg-3">
                    <form action="{{route('restaurants', [$current_language->code, $regionGroup->slug])}}" method="GET">
                                                ...
                                                <div class="cruise_item_inner_content">
                                                    ...
                                                    <div class="cruise_content_bottom_wrapper">
                                                        ...
                                                        <div class="cruise_content_bottom_right">
                                                            <a href="{{route('restaurants-show', [$current_language->code, $place->slug])}}" class="btn btn_theme btn_md">{{__('view_details')}}</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
