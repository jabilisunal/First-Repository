    ...
    var _componentDatatableButtonsHtml5 = function() {
        ...
        $('.datatable-button-html5-columns').DataTable({
            language: {
                ...
                "info":           "_PAGES_ səhifədən _PAGE_ səhifə göstərilir",
                "infoEmpty":      "Heç bir qeyd yoxdur",
                "infoFiltered":   "(cəmi _MAX_ sətrdən süzülüb)",
                "infoPostFix":    "",
                "thousands":      ",",
                "lengthMenu":     "Hər səhifədə _MENU_ sətir göstərin",
                "loadingRecords": "Yüklənir...",
                "processing":     "Emal edilir...",
                "search":         "Axtar: ",
                "searchPlaceholder":         "Filtr etmək üçün yazın...",
                "zeroRecords":    "Heç nə tapılmadı - üzr istəyirik",
                "paginate": {
                    "first":      "Birinci",
                    "last":       "Son",
                    "next":       "Sonrakı",
                ...
                "aria": {
                    "sortAscending":  ": sütunu artan üzrə çeşidləmək üçün aktivləşdirin",
                    "sortDescending": ": sütunu azalan üzrə çeşidləmək üçün aktivləşdirin"
                }
            },
            buttons: {
                buttons: [
                ...
                buttons: [
                    {
                        extend: 'copyHtml5',
                        className: 'btn btn-light',
                        text: '<i class="icon-copy3 mr-2"></i> Kopyala'
                    },
                    {
                        extend: 'csvHtml5',
                        className: 'btn btn-light',
