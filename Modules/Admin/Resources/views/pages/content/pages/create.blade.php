...
@section('content')
    @push('breadcrumb-buttons')
        <div class="page-title d-flex">
            <h4>
                <a class="text-black-50" href="{{route('content.pages.index')}}"> Səhifə əlavə et</a>
            </h4>
    ...
    <div class="row">
        <div class="col-md-12">
            <form action="{{route('content.pages.store')}}" method="post" enctype="multipart/form-data" id="submit-form">
