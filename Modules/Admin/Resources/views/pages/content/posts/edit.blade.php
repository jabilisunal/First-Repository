...
@section('content')
    @push('breadcrumb-buttons')
        <div class="page-title d-flex">
            <h4>
                <a class="text-black-50" href="{{route('content.posts.index')}}"> Bloga düzəliş et</a>
            </h4>
    ...
    <div class="row">
        <div class="col-md-12">
            <form action="{{route('content.posts.update', [$post->id])}}" method="post" enctype="multipart/form-data" id="submit-form">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade show active" id="general">
                                <fieldset class="mb-3">
                                    ...
                                    @if(isset($post->base_image))
                                        <div class="form-group row">
                                            <div class="col-form-label col-lg-2 font-weight-semibold"></div>
                                            <div class="col-lg-10">
                                                <div class="form-group-feedback form-group-feedback-right">
                                                    <img style="width: 200px; height: 100px; object-fit: contain;" src="/storage/{{$post->base_image->path}}" alt="Image Preview">
                                                </div>
                                            </div>
                                        </div>
                                    @endif
                                            ...
                                            <div class="form-group-feedback form-group-feedback-right">
                                                <div class="form-check form-check-switchery">
                                                    <label class="form-check-label">
                                                        <input type="checkbox" id="status" class="form-check-input-switchery" @if($post->status === 1) checked="checked" @endif name="status" data-fouc>
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        <label for="is_popular" class="col-form-label col-lg-2 font-weight-semibold">
                                            Popular Post:
                                        </label>
                                        <div class="col-lg-10">
                                            <div class="form-group-feedback form-group-feedback-right">
                                                <div class="form-check form-check-switchery">
                                                    <label class="form-check-label">
                                                        <input type="checkbox" id="is_popular" class="form-check-input-switchery" @if($post->is_popular === 1) checked="checked" @endif name="is_popular" data-fouc>
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
