...
@section('content')
    @push('breadcrumb-buttons')
        <div class="page-title d-flex">
            <h4>
                <a class="text-black-50" href="{{route('user.user.index')}}"> İstifadəçiyə düzəliş et</a>
            </h4>
    ...
    @can('user:user-update')
        ...
        <div class="row">
            <div class="col-md-12">
                <form action="{{route('user.user.update', [$user->id])}}" method="post" id="submit-form" enctype="multipart/form-data">
                                ...
                                <div class="tab-pane fade show active" id="general">
                                    <fieldset class="mb-3">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-10">
                                                <div class="form-group-feedback form-group-feedback-right">
                                                    <input id="name" name="name" type="text" value="{{old('name') ?? $user->name}}" class="form-control @if($errors->has('name')) border-danger @endif">
                                                    @if($errors->has('name'))
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-10">
                                                <div class="form-group-feedback form-group-feedback-right">
                                                    <input id="surname" name="surname" type="text" value="{{old('surname') ?? $user->surname}}" class="form-control @if($errors->has('surname')) border-danger @endif">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-10">
                                                <div class="form-group-feedback form-group-feedback-right">
                                                    <input id="email" name="email" type="text" value="{{old('email') ?? $user->email}}" class="form-control @if($errors->has('email')) border-danger @endif">
                                                    @if($errors->has('email'))
                                                        <div class="form-control-feedback text-danger">
                                                            <i class="icon-cancel-circle2"></i>
                                                        </div>
                                                ...
                                                <div class="form-group-feedback form-group-feedback-right">
                                                    <select id="position_id" class="select-search @if($errors->has('position_id')) border-danger @endif" name="position_id">
                                                        ...
                                                        @foreach($positions as $position)
                                                            <option value="{{$position->id}}" @if($position->id === $user->position_id) selected @endif>{{$position->position_name}}</option>
                                                        @endforeach
                                                    </select>
                                                    ...
                                                    <div class="form-group-feedback form-group-feedback-right">
                                                        <div class="form-check form-check-switchery">
                                                            <label class="form-check-label">
                                                                <input type="checkbox" id="status" class="form-check-input-switchery" name="permissions[]" value="{{$permission->id}}"
                                                                       @if(in_array($permission->id, $user->permissions->pluck('id')->toArray(), true)) checked @endif
                                                                       data-fouc>
                                                            </label>
                                                        </div>
                                                    </div>
