...
@section('content')
    @push('breadcrumb-buttons')
        <div class="page-title d-flex">
            <h4>
                <a class="text-black-50" href="{{route('ecommerce.places.index')}}"> Place əlavə et</a>
            </h4>
    ...
    <div class="row">
        <div class="col-md-12">
            <form action="{{route('ecommerce.places.store')}}" method="post" enctype="multipart/form-data" id="submit-form">
                            ...
                            <div class="tab-pane fade show active" id="general">
                                <fieldset class="mb-3">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-10">
                                            <div class="form-group-feedback form-group-feedback-right">
                                                <input id="price" name="price" type="number" value="{{old('price')}}" class="form-control @if($errors->has('price')) border-danger @endif">
                                                @if($errors->has('price'))
                                                    <div class="form-control-feedback text-danger">
                                                        <i class="icon-cancel-circle2"></i>
                                                    </div>
                                        ...
                                        <div class="tab-pane fade @if($key === 0) show active @endif" id="{{$language->short_name}}">
                                            <fieldset class="mb-3 p-3">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-10">
                                                        <div class="form-group-feedback form-group-feedback-right">
                                                            <textarea name="why_choose_us[{{$language->code}}]" id="why_choose_us_{{$language->code}}" cols="30" rows="10" class="form-control ckeditor @if($errors->has('why_choose_us')) border-danger @endif">{{old('why_choose_us') ? old('why_choose_us')[$language->code] : ''}}</textarea>
