...
@section('content')
    @push('breadcrumb-buttons')
        <div class="page-title d-flex">
            <h4>
                <a class="text-black-50" href="{{route('ecommerce.destinations.index')}}"> İstiqamət əlavə et</a>
            </h4>
    ...
    <div class="row">
        <div class="col-md-12">
            <form action="{{route('ecommerce.destinations.store')}}" method="post" enctype="multipart/form-data" id="submit-form">
