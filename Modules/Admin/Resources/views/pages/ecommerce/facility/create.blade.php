...
@section('content')
    @push('breadcrumb-buttons')
        <div class="page-title d-flex">
            <h4>
                <a class="text-black-50" href="{{route('ecommerce.facilities.index')}}"> Xüsusiyət əlavə et</a>
            </h4>
    ...
    <div class="row">
        <div class="col-md-12">
            <form action="{{route('ecommerce.facilities.store')}}" method="post" enctype="multipart/form-data" id="submit-form">
                                            ...
                                            <div class="form-group-feedback form-group-feedback-right">
                                                <select id="type" class="select-search @if($errors->has('type')) border-danger @endif" name="type">
                                                    ...
                                                    @foreach($facilityTypes as $key => $facilityType)
                                                        <option value="{{$key}}" @if($key === old('type')) selected @endif>{{$facilityType}}</option>
                                                    @endforeach
                                                </select>
                                                @if($errors->has('type'))
