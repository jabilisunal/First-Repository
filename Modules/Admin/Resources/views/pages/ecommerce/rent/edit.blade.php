...
@section('content')
    @push('breadcrumb-buttons')
        <div class="page-title d-flex">
            <h4>
                <a class="text-black-50" href="{{route('ecommerce.rents.index')}}"> Rent Car düzəliş et</a>
            </h4>
    ...
    <div class="row">
        <div class="col-md-12">
            <form action="{{route('ecommerce.rents.update', [$rent->id])}}" method="post" enctype="multipart/form-data" id="submit-form">
                            ...
                            <div class="tab-pane fade show active" id="general">
                                <fieldset class="mb-3">
                                    ...
                                    <div class="form-group row">
                                        <label for="brand_id" class="col-form-label col-lg-2 font-weight-semibold @if($errors->has('brand_id')) text-danger @endif">
                                            Brand
                                        </label>
                                        <div class="col-lg-10">
                                            <div class="form-group-feedback form-group-feedback-right">
                                                <select id="brand_id" class="select-search @if($errors->has('brand_id')) border-danger @endif" name="brand_id">
                                                    <option value="" @if($rent->brand_id === '') selected @endif>Seçilməyib</option>
                                                    @foreach($brands as $brand)
                                                        <option value="{{$brand->id}}" @if($brand->id === $rent->brand_id) selected @endif>{{$brand->title}}</option>
                                                    @endforeach
                                                </select>
                                            ...
                                            @if($errors->has('brand_id'))
                                                <span class="form-text text-danger">{{$errors->first('brand_id')}}</span>
                                            @endif
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-lg-10">
                                            <div class="form-group-feedback form-group-feedback-right">
                                                <select id="category_id" class="select-search @if($errors->has('category_id')) border-danger @endif" name="category_id">
                                                    <option value="" @if($rent->category_id === '') selected @endif>Seçilməyib</option>
                                                    @foreach($categories as $category)
                                                        <option value="{{$category->id}}" @if($category->id === $rent->category_id) selected @endif>{{$category->title}}</option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="form-group-feedback form-group-feedback-right">
                                                <select id="region_group_id" class="select-search @if($errors->has('region_group_id')) border-danger @endif" name="region_group_id">
                                                    ...
                                                    @foreach($regionGroups as $regionGroup)
                                                        <option value="{{$regionGroup->id}}" @if($regionGroup->id === $rent->region_group_id) selected @endif>{{$regionGroup->name}}</option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col-lg-10">
                                            <div class="form-group-feedback form-group-feedback-right">
                                                <select id="destination_id" class="select-search @if($errors->has('destination_id')) border-danger @endif" name="destination_id">
                                                    <option value="" @if($rent->destination_id === '') selected @endif>Seçilməyib</option>
                                                    @foreach($destinations as $destination)
                                                        <option value="{{$destination->id}}" @if($destination->id === $rent->destination_id) selected @endif>{{$destination->name}}</option>
                                                    @endforeach
                                                </select>
                                    ...
                                    <div class="form-group row">
                                        <label for="year" class="col-form-label col-lg-2 font-weight-semibold @if($errors->has('year')) text-danger @endif">
                                            İl
                                        </label>
                                        <div class="col-lg-10">
                                            <div class="form-group-feedback form-group-feedback-right">
                                                <input id="year" name="year" type="number"
                                                       value="{{$rent->year ?? 2013}}"
                                                       class="form-control @if($errors->has('year')) border-danger @endif">
                                                @if($errors->has('year'))
                                                    <div class="form-control-feedback text-danger">
                                                        <i class="icon-cancel-circle2"></i>
                                                    </div>
                                            ...
                                            @if($errors->has('year'))
                                                <span class="form-text text-danger">{{$errors->first('year')}}</span>
                                            @endif
                                        </div>
                                    </div>

                                    <div class="form-group row">
                                        <label for="seats" class="col-form-label col-lg-2 font-weight-semibold @if($errors->has('seats')) text-danger @endif">
                                            Oturacaq sayı
                                        </label>
                                        <div class="col-lg-10">
                                            <div class="form-group-feedback form-group-feedback-right">
                                                <input id="seats" name="seats" type="number"
                                                       value="{{$rent->seats ?? 5}}"
                                                       class="form-control @if($errors->has('seats')) border-danger @endif">
                                                @if($errors->has('seats'))
                                                    <div class="form-control-feedback text-danger">
                                                        <i class="icon-cancel-circle2"></i>
                                                    </div>
                                            ...
                                            @if($errors->has('seats'))
                                                <span class="form-text text-danger">{{$errors->first('seats')}}</span>
                                            @endif
                                        </div>
                                    </div>

                                    <div class="form-group row">
                                        <label for="engine_type" class="col-form-label col-lg-2 font-weight-semibold @if($errors->has('engine_type')) text-danger @endif">
                                            Mator tipi
                                        </label>
                                        <div class="col-lg-10">
                                            <div class="form-group-feedback form-group-feedback-right">
                                                <select id="engine_type" class="select-search @if($errors->has('style')) border-danger @endif" name="engine_type">
                                                    @foreach($engineTypes as $engineType)
                                                        <option value="{{$engineType}}" @if($engineType === $rent->engine_type) selected @endif>{{$engineType}}</option>
                                                    @endforeach
                                                </select>
                                            ...
                                            @if($errors->has('engine_type'))
                                                <span class="form-text text-danger">{{$errors->first('engine_type')}}</span>
                                            @endif
                                        </div>
                                    </div>

                                    <div class="form-group row">
                                        <label for="daily_price" class="col-form-label col-lg-2 font-weight-semibold @if($errors->has('daily_price')) text-danger @endif">
                                            Günlük Qiymət
                                        </label>
                                        <div class="col-lg-10">
                                            <div class="form-group-feedback form-group-feedback-right">
                                                <input id="daily_price" name="daily_price" value="{{$rent->daily_price}}" class="form-control @if($errors->has('daily_price')) border-danger @endif">
                                            ...
                                            @if($errors->has('daily_price'))
                                                <span class="form-text text-danger">{{$errors->first('daily_price')}}</span>
                                            @endif
                                        </div>
                                    </div>

                                    <div class="form-group row">
                                        <label for="weekly_price" class="col-form-label col-lg-2 font-weight-semibold @if($errors->has('weekly_price')) text-danger @endif">
                                            Həftəlik Qiymət
                                        </label>
                                        <div class="col-lg-10">
                                            <div class="form-group-feedback form-group-feedback-right">
                                                <input id="weekly_price" name="weekly_price"  value="{{$rent->weekly_price}}" class="form-control @if($errors->has('weekly_price')) border-danger @endif">
                                            ...
                                            @if($errors->has('weekly_price'))
                                                <span class="form-text text-danger">{{$errors->first('weekly_price')}}</span>
                                            @endif
                                        </div>
                                    </div>

                                    <div class="form-group row">
                                        <label for="monthly_price" class="col-form-label col-lg-2 font-weight-semibold @if($errors->has('monthly_price')) text-danger @endif">
                                            Aylıq Qiymət
                                        </label>
                                        <div class="col-lg-10">
                                            <div class="form-group-feedback form-group-feedback-right">
                                                <input id="monthly_price" name="monthly_price" value="{{$rent->monthly_price}}" class="form-control @if($errors->has('monthly_price')) border-danger @endif">
                                            ...
                                            @if($errors->has('monthly_price'))
                                                <span class="form-text text-danger">{{$errors->first('monthly_price')}}</span>
                                            @endif
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-lg-10">
                                            <div class="form-group-feedback form-group-feedback-right">
                                                <select id="tags" class="select-search" name="tags[]" multiple>
                                                    @foreach($tags as $tag)
                                                        <option value="{{$tag->id}}" @if(in_array($tag->id, $rent->tags->pluck('id')->toArray(), true)) selected @endif>{{$tag->name}}</option>
                                                    @endforeach
                                                </select>
                                                @if($errors->has('tags'))
                                                    <div class="form-control-feedback text-danger">
                                            ...
                                            <div class="form-group-feedback form-group-feedback-right">
                                                <select id="facilities" class="select-search" name="facilities[]" multiple>
                                                    @foreach($facilities as $facility)
                                                        <option value="{{$facility->id}}" @if(in_array($facility->id, $rent->facilities->pluck('id')->toArray(), true)) selected @endif>{{$facility->name}}</option>
                                                    @endforeach
                                                </select>
                                    ...
                                    @if(isset($rent->base_image))
                                        <div class="form-group row">
                                            <div class="col-form-label col-lg-2 font-weight-semibold"></div>
                                            <div class="col-lg-10">
                                                <div class="form-group-feedback form-group-feedback-right">
                                                    <img style="width: 200px; height: 100px; object-fit: contain;" src="/storage/public/media/{{$rent->base_image->path}}" alt="Image Preview">
                                                </div>
                                            </div>
                                        </div>
                                    @endif
                                    ...
                                    @if(isset($rent->cover_image))
                                        <div class="form-group row">
                                            <div class="col-form-label col-lg-2 font-weight-semibold"></div>
                                            <div class="col-lg-10">
                                                <div class="form-group-feedback form-group-feedback-right">
                                                    <img style="width: 200px; height: 100px; object-fit: contain;" src="/storage/public/media/{{$rent->cover_image->path}}" alt="Image Preview">
                                                </div>
                                            </div>
                                        </div>
                                    @endif
                                            ...
                                            <div class="form-group-feedback form-group-feedback-right">
                                                <div class="form-check form-check-switchery">
                                                    <label class="form-check-label">
                                                        <input type="checkbox" id="is_popular" class="form-check-input-switchery" @if((string) $rent->is_popular === "1") checked="checked" @endif name="is_popular" data-fouc>
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-10">
                                            <div class="form-group-feedback form-group-feedback-right">
                                                <div class="form-check form-check-switchery">
                                                    <label class="form-check-label">
                                                        <input type="checkbox" id="status" class="form-check-input-switchery" @if((string) $rent->status === "1") checked="checked" @endif name="status" data-fouc>
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-lg-10">
                                        <div class="form-group-feedback form-group-feedback-right">
                                            <input id="address_name" name="address_name" type="text"
                                                   value="{{old('address_name') ?? $rent->address?->name}}"
                                    ...
                                    <div class="col-lg-10">
                                        <div class="form-group-feedback form-group-feedback-right">
                                            <input id="address_latitude" name="address_latitude" type="text"
                                                   value="{{old('address_latitude') ?? $rent->address?->latitude}}"
                                    ...
                                    <div class="col-lg-10">
                                        <div class="form-group-feedback form-group-feedback-right">
                                            <input id="address_longitude" name="address_longitude" type="text"
                                                   value="{{old('address_longitude') ?? $rent->address?->longitude}}"
                                    ...
                                    <div class="col-lg-10">
                                        <div class="form-group-feedback form-group-feedback-right">
                                            <input id="address_zoom" name="address_zoom" type="text"
                                                   value="{{old('address_zoom') ?? $rent->address?->zoom}}"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-10">
                                        <div class="form-group-feedback form-group-feedback-right">
                                            <div class="form-check form-check-switchery">
                                                <label class="form-check-label">
                                                    <input type="checkbox" id="address_status" class="form-check-input-switchery" @if((string) (old('address_status') ?? $rent->address?->status) === "1") checked="checked" @endif name="address_status" data-fouc>
                                                </label>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    @foreach($languages as $key => $language)
                                        <div class="tab-pane fade @if($key === 0) show active @endif" id="{{$language->short_name}}">
                                            <fieldset class="mb-3 p-3">
                                                ...
                                                <div class="form-group row">
                                                    <label for="color_{{$language->code}}" class="col-form-label col-lg-2 font-weight-semibold @if($errors->has('color')) text-danger @endif">
                                                        Rəng
                                                    </label>
                                                    <div class="col-lg-10">
                                                        <div class="form-group-feedback form-group-feedback-right">
                                                            <input name="color[{{$language->code}}]" id="color_{{$language->code}}"  type="text"
                                                                   value="{{(old('color')[$language->code] ?? null) ?? ($translations[$language->code]['color'] ?? '')}}"
                                                                   class="form-control @if($errors->has('color')) border-danger @endif">
                                                            @if($errors->has('color'))
                                                                <div class="form-control-feedback text-danger">
                                                                    <i class="icon-cancel-circle2"></i>
                                                                </div>
