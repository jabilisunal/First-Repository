...
@section('content')
    @push('breadcrumb-buttons')
        <div class="page-title d-flex">
            <h4>
                <a class="text-black-50" href="{{route('ecommerce.rents.index')}}"> Rent Car əlavə et</a>
            </h4>
    ...
    <div class="row">
        <div class="col-md-12">
            <form action="{{route('ecommerce.rents.store')}}" method="post" enctype="multipart/form-data" id="submit-form">
                            ...
                            <div class="tab-pane fade show active" id="general">
                                <fieldset class="mb-3">
                                        ...
                                        <div class="col-lg-10">
                                            <div class="form-group-feedback form-group-feedback-right">
                                                <select id="brand_id" class="select-search @if($errors->has('brand_id')) border-danger @endif" name="brand_id">
                                                    <option value="" @if(old('brand_id') === '') selected @endif>Seçilməyib</option>
                                            ...
                                            <div class="form-group-feedback form-group-feedback-right">
                                                <select id="region_group_id" class="select-search @if($errors->has('region_group_id')) border-danger @endif" name="region_group_id">
                                                    ...
                                                    @foreach($regionGroups as $regionGroup)
                                                        <option value="{{$regionGroup->id}}" @if($regionGroup->id === old('region_group_id')) selected @endif>{{$regionGroup->name}}</option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="form-group-feedback form-group-feedback-right">
                                                <select id="destination_id" class="select-search @if($errors->has('destination_id')) border-danger @endif" name="destination_id">
                                                    ...
                                                    @foreach($destinations as $destination)
                                                        <option value="{{$destination->id}}" @if($destination->id === old('destination_id')) selected @endif>{{$destination->name}}</option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="form-group-feedback form-group-feedback-right">
                                                <select id="engine_type" class="select-search @if($errors->has('style')) border-danger @endif" name="engine_type">
                                                    @foreach($engineTypes as $engineType)
                                                        <option value="{{$engineType}}" @if($engineType === old('engine_type')) selected @endif>{{$engineType}}</option>
                                                    @endforeach
                                                </select>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-10">
                                            <div class="form-group-feedback form-group-feedback-right">
                                                <input id="daily_price" name="daily_price" value="{{old('daily_price')}}" class="form-control @if($errors->has('daily_price')) border-danger @endif">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-10">
                                            <div class="form-group-feedback form-group-feedback-right">
                                                <input id="weekly_price" name="weekly_price"  value="{{old('weekly_price')}}" class="form-control @if($errors->has('weekly_price')) border-danger @endif">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-10">
                                            <div class="form-group-feedback form-group-feedback-right">
                                                <input id="monthly_price" name="monthly_price" value="{{old('monthly_price')}}" class="form-control @if($errors->has('monthly_price')) border-danger @endif">
                                        ...
                                        <div class="col-lg-10">
                                            <div class="form-group-feedback form-group-feedback-right">
                                                <select id="tags" class="select-search" name="tags[]" multiple>
                                                    @foreach($tags as $tag)
                                                        <option value="{{$tag->id}}" @if(in_array((string) $tag->id, old('tags', []), true)) selected @endif>{{$tag->name}}</option>
                                                    @endforeach
                                                </select>
                                                @if($errors->has('tags'))
                                                    <div class="form-control-feedback text-danger">
                                            ...
                                            <div class="form-group-feedback form-group-feedback-right">
                                                <select id="facilities" class="select-search" name="facilities[]" multiple>
                                                    @foreach($facilities as $facility)
                                                        <option value="{{$facility->id}}" @if(in_array((string) $facility->id, old('facilities', []), true)) selected @endif>{{$facility->name}}</option>
                                                    @endforeach
                                                </select>
                                    ...
                                    <div class="form-group row">
                                        <label for="cover" class="col-form-label col-lg-2 font-weight-semibold @if($errors->has('cover')) text-danger @endif">
                                            Cover Photo
                                        </label>
                                        <div class="col-lg-10">
                                            <div class="form-group-feedback form-group-feedback-right">
                                            ...
                                            <div class="form-group-feedback form-group-feedback-right">
                                                <div class="form-check form-check-switchery">
                                                    <label class="form-check-label">
                                                        <input type="checkbox" id="is_popular" class="form-check-input-switchery" @if((string) old('is_popular') === "1") checked="checked" @endif name="is_popular" data-fouc>
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-10">
                                        <div class="form-group-feedback form-group-feedback-right">
                                            <div class="form-check form-check-switchery">
                                                <label class="form-check-label">
                                                    <input type="checkbox" id="address_status" class="form-check-input-switchery" @if((string) old('address_status') === "1") checked="checked" @endif name="address_status" data-fouc>
                                                </label>
                                            </div>
                                        </div>
                                    </div>
                                                    ...
                                                    <div class="col-lg-10">
                                                        <div class="form-group-feedback form-group-feedback-right">
                                                            <input name="color[{{$language->code}}]" id="color_{{$language->code}}"  type="text"
                                                                   value="{{old('color') ? old('color')[$language->code] : ''}}"
