...
@section('content')
    @push('breadcrumb-buttons')
        <div class="page-title d-flex">
            <h4>
                <a class="text-black-50" href="{{route('ecommerce.tours.index')}}"> Tour düzəliş et</a>
            </h4>
    ...
    <div class="row">
        <div class="col-md-12">
            <form action="{{route('ecommerce.tours.update', [$tour->id])}}" method="post" enctype="multipart/form-data" id="submit-form">
                            ...
                            <div class="tab-pane fade show active" id="general">
                                <fieldset class="mb-3">
                                            ...
                                            <div class="form-group-feedback form-group-feedback-right">
                                                <select id="region_group_id" class="select-search @if($errors->has('region_group_id')) border-danger @endif" name="region_group_id">
                                                    ...
                                                    @foreach($regionGroups as $regionGroup)
                                                        <option value="{{$regionGroup->id}}" @if($regionGroup->id === $tour->region_group_id) selected @endif>{{$regionGroup->name}}</option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="form-group-feedback form-group-feedback-right">
                                                <select id="destination_id" class="select-search @if($errors->has('destination_id')) border-danger @endif" name="destination_id">
                                                    ...
                                                    @foreach($destinations as $destination)
                                                        <option value="{{$destination->id}}" @if($destination->id === $tour->destination_id) selected @endif>{{$destination->name}}</option>
                                                    @endforeach
                                                </select>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-10">
                                            <div class="form-group-feedback form-group-feedback-right">
                                                <input id="price" name="price" type="number" value="{{$tour->price}}" class="form-control @if($errors->has('price')) border-danger @endif">
                                                @if($errors->has('price'))
                                                    <div class="form-control-feedback text-danger">
                                                        <i class="icon-cancel-circle2"></i>
                                                    </div>
                                        ...
                                        <div class="col-lg-10">
                                            <div class="form-group-feedback form-group-feedback-right">
                                                <select id="tags" class="select-search" name="tags[]" multiple>
                                                    @foreach($tags as $tag)
                                                        <option value="{{$tag->id}}" @if(in_array($tag->id, $tour->tags->pluck('id')->toArray(), true)) selected @endif>{{$tag->name}}</option>
                                                    @endforeach
                                                </select>
                                                @if($errors->has('tags'))
                                                    <div class="form-control-feedback text-danger">
                                            ...
                                            <div class="form-group-feedback form-group-feedback-right">
                                                <select id="facilities" class="select-search" name="facilities[]" multiple>
                                                    @foreach($facilities as $facility)
                                                        <option value="{{$facility->id}}" @if(in_array($facility->id, $tour->facilities->pluck('id')->toArray(), true)) selected @endif>{{$facility->name}}</option>
                                                    @endforeach
                                                </select>
                                    ...
                                    @if(isset($tour->base_image))
                                        <div class="form-group row">
                                            <div class="col-form-label col-lg-2 font-weight-semibold"></div>
                                            <div class="col-lg-10">
                                                <div class="form-group-feedback form-group-feedback-right">
                                                    <img style="width: 200px; height: 100px; object-fit: contain;" src="/storage/public/media/{{$tour->base_image->path}}" alt="Image Preview">
                                                </div>
                                            </div>
                                        </div>
                                    @endif
                                    ...
                                    @if(isset($tour->cover_image))
                                        <div class="form-group row">
                                            <div class="col-form-label col-lg-2 font-weight-semibold"></div>
                                            <div class="col-lg-10">
                                                <div class="form-group-feedback form-group-feedback-right">
                                                    <img style="width: 200px; height: 100px; object-fit: contain;" src="/storage/public/media/{{$tour->cover_image->path}}" alt="Image Preview">
                                                </div>
                                            </div>
                                        </div>
                                    @endif
                                            ...
                                            <div class="form-group-feedback form-group-feedback-right">
                                                <div class="form-check form-check-switchery">
                                                    <label class="form-check-label">
                                                        <input type="checkbox" id="is_popular" class="form-check-input-switchery" @if((string) $tour->is_popular === "1") checked="checked" @endif name="is_popular" data-fouc>
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-10">
                                            <div class="form-group-feedback form-group-feedback-right">
                                                <div class="form-check form-check-switchery">
                                                    <label class="form-check-label">
                                                        <input type="checkbox" id="status" class="form-check-input-switchery" @if((string) $tour->status === "1") checked="checked" @endif name="status" data-fouc>
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-lg-10">
                                        <div class="form-group-feedback form-group-feedback-right">
                                            <input id="address_name" name="address_name" type="text"
                                                   value="{{old('address_name') ?? $tour->address?->name}}"
                                    ...
                                    <div class="col-lg-10">
                                        <div class="form-group-feedback form-group-feedback-right">
                                            <input id="address_latitude" name="address_latitude" type="text"
                                                   value="{{old('address_latitude') ?? $tour->address?->latitude}}"
                                    ...
                                    <div class="col-lg-10">
                                        <div class="form-group-feedback form-group-feedback-right">
                                            <input id="address_longitude" name="address_longitude" type="text"
                                                   value="{{old('address_longitude') ?? $tour->address?->longitude}}"
                                    ...
                                    <div class="col-lg-10">
                                        <div class="form-group-feedback form-group-feedback-right">
                                            <input id="address_zoom" name="address_zoom" type="text"
                                                   value="{{old('address_zoom') ?? $tour->address?->zoom}}"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-10">
                                        <div class="form-group-feedback form-group-feedback-right">
                                            <div class="form-check form-check-switchery">
                                                <label class="form-check-label">
                                                    <input type="checkbox" id="address_status" class="form-check-input-switchery" @if((string) (old('address_status') ?? $tour->address?->status) === "1") checked="checked" @endif name="address_status" data-fouc>
                                                </label>
                                            </div>
                                        </div>
                                    </div>
