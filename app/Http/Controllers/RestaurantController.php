...
class RestaurantController extends Controller
{
    ...
    {
        $restaurant = Place::where(['category_id' => Category::RESTAURANT, 'slug' => $slug, 'status' => 1])->first();

        abort_if(!$restaurant, Response::HTTP_NOT_FOUND);

        $relatedRestaurants = Place::where([
            'category_id' => Category::RESTAURANT,
